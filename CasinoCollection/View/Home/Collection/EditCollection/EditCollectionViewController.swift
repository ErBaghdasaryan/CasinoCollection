...
class EditCollectionViewController: BaseViewController {
    ...
    private let pageTitle = UILabel(text: "Edit an entry",
                                    textColor: .white,
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.firstImage.setup(with: model.firstImage)
        self.firstSelectedImage = model.firstImage
        self.secondImage.setup(with: model.secondImage)
        self.seconfSelectedImage = model.secondImage
        self.thirdImage.setup(with: model.thirdImage)
        self.thirdSelectedImage = model.thirdImage
        self.fourthImage.setup(with: model.fourthImage)
        self.selectedText = model.nominalValue
        self.fourthSelectedImage = model.fourthImage
        self.titleField.textField.text = model.title
        self.addressField.textField.text = model.address
        self.descriptionField.textField.text = model.description
        self.priceField.textField.text = model.price
    }
    ...
    override func setupUI() {
        ...
        self.edit.backgroundColor = UIColor(hex: "#920A98")
        self.edit.layer.masksToBounds = true
        self.edit.layer.cornerRadius = 12
        self.edit.setTitle("Edit", for: .normal)
        self.edit.setTitleColor(.white, for: .normal)
    ...
    private func setupConstraints() {
        ...
        edit.snp.makeConstraints { view in
...
extension EditCollectionViewController{
    
    private func makeButtonsAction() {
        self.edit.addTarget(self, action: #selector(editTapped), for: .touchUpInside)
...
extension EditCollectionViewController: IViewModelableController {
    typealias ViewModel = IEditCollectionViewModel
}

//MARK: Image Picker
extension EditCollectionViewController: UIImagePickerControllerDelegate & UINavigationControllerDelegate {
...
extension EditCollectionViewController: UITextFieldDelegate, UITextViewDelegate {
    ...
    private func updateButtonBackgroundColor() {
        ...
        self.edit.backgroundColor = buttonColor
        self.edit.setTitleColor(titleColor, for: .normal)
        self.edit.isUserInteractionEnabled = allFieldsFilled ? true : false
    }
...
extension EditCollectionViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
...
struct EditCollectionViewControllerProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: UIViewControllerRepresentableContext<EditCollectionViewControllerProvider.ContainerView>) -> EditCollectionViewController {
            return editCollectionViewController
        }

        func updateUIViewController(_ uiViewController: EditCollectionViewControllerProvider.ContainerView.UIViewControllerType, context: UIViewControllerRepresentableContext<EditCollectionViewControllerProvider.ContainerView>) {
        }
    }
}
